...
2. Inspect existing app structure before editing: `app.py`, `src/config.py`, `src/binance_client.py`, `src/indicators.py`, `src/signals.py`, `src/paper_worker.py`, `src/storage.py`, `src/paper_trading.py`, `src/ml.py`, and `tests/`.
